...
const AnnapurnaRasoiShradhaluSeva = ({ BASE_URL }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    fd.append("video_description", formData.video_description);
    ...
    try {
      ...
      if (editingId) {
        res = await axios.put(
          `${BASE_URL}/api/updateannapurnarasoi_shraddhaluseva/${editingId}`,
          fd,
        ...
        res = await axios.post(
          `${BASE_URL}/api/insertannapurnarasoi_shraddhaluseva`,
          fd,
          { headers: { apikey: apiKey } }
        );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(
        `${BASE_URL}/api/deleteannapurnarasoi_shraddhaluseva/${id}`,
        { headers: { apikey: "12345" } }
      );
  ...
  const toggleStatus = async (id) => {
    try {
      const res = await axios.patch(
        `${BASE_URL}/api/statusannapurnarasoi_shraddhaluseva/${id}/status`,
        {},
        { headers: { apikey: "12345" } }
      );
  ...
  return (
    <div className="top-banner">
      <div className="d-flex justify-content-between mb-3">
        <h3>Annapurna Rasoi ShradhaluSeva</h3>
        <button
      ...
      {/* TABLE */}
      <div className="card">
        <div className="card-header">Annapurna Rasoi ShradhaluSeva</div>
        <div className="card-body">
          ...
          <div className="modal-dialog modal-lg" style={{ maxWidth: "1200px" }}>
            <div className="modal-content">
              <div className="modal-header">
                <h5>Edit Annapurna Rasoi Shradhalu Seva</h5>
                <button
                  className="btn-close"
...
export default AnnapurnaRasoiShradhaluSeva;
