...
const AnnapurnaRasoiVideoSlider = ({ BASE_URL }) => {
    ...
    try {
      ...
      if (editingId) {
        const res = await axios.put(
          `${BASE_URL}/api/updateannapurnarasoi_videoslider/${editingId}`,
          fd,
        ...
        const res = await axios.post(
          `${BASE_URL}/api/insertannapurnarasoi_videoslider`,
          fd,
          { headers: { apikey: "12345", "Content-Type": "multipart/form-data" } }
        );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`${BASE_URL}/api/deleteannapurnarasoi_videoslider/${id}`, {
  ...
  const toggleStatus = async (id) => {
    try {
      const res = await axios.patch(
        `${BASE_URL}/api/statusannapurnarasoi_videoslider/${id}/status`,
        {},
        { headers: { apikey: "12345" } }
      );
      setEventsslide((prev) =>
  ...
  useEffect(() => {
    axios
      .get(`${BASE_URL}/api/selectannapurnarasoi_videoslider`, {
        headers: { apikey: "12345" },
      })
  ...
  return (
    <div className="top-banner">
      <div className="d-flex justify-content-between align-items-center mb-3">
        <h3>Annapurna Rasoi Video Slider</h3>
        <button
...
export default AnnapurnaRasoiVideoSlider;
