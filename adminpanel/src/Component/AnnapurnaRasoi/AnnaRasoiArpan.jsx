...
const AnnaRasoiArpan = ({ BASE_URL }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        res = await axios.put(
          `${BASE_URL}/api/updateannarasoi_arpan/${editingId}`,
          fd,
        ...
        res = await axios.post(
          `${BASE_URL}/api/insertannarasoi_arpan`,
          fd,
          { headers: { apikey: apiKey } }
        );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(
        `${BASE_URL}/api/deleteannarasoi_arpan/${id}`,
        { headers: { apikey: "12345" } }
      );
  ...
  const toggleStatus = async (id) => {
    try {
      const res = await axios.patch(
        `${BASE_URL}/api/statusannarasoi_arpan/${id}/status`,
        {},
        { headers: { apikey: "12345" } }
      );
  ...
  return (
    <div className="top-banner">
      ...
      {/* TABLE */}
      <div className="card">
        <div className="card-header">Anna Purna Rasoi</div>
        <div className="card-body">
